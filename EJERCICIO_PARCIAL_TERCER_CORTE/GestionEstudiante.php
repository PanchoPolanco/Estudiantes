            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="GuardarEstudiante.php" method="POST">
                        ...
                        <button type="submit" class="btn btn-success" name="GuardarEstudiante" value="Registrar">Registrar</button>
                    </form>
                </div>
                ...
                <div class="modal-body">
                    <form action="EditarEstudiante.php" method="POST">
                        ...
                        <div class="row mb-3">
                            <label for="inputEmail3" class="col-sm-2 col-form-label">Grupo</label>
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="grupo2" placeholder="grupo">
                            </div>
                        </div>
                        <button type="submit" class="btn btn-secondary"  name="EditarEstudiante" value="Editar">Editar</button>
                    </form>
                </div>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <th>
                        <a class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#myModalEdi">Editar</a>
                    </th>
                    <th>
